  ...
  function Modal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Modal.__proto__ || Object.getPrototypeOf(Modal)).call.apply(_ref, [this].concat(args))), _this), _this.handleOnTrue = function (e) {
      ...
      if (typeOfIcon === 'string') {
        iconNode = _react2.default.createElement('img', { src: icon, className: 'modal-icon' });
      } else {
        iconNode = icon;
      }
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      var defaultFooter = [_react2.default.createElement(
        _Button2.default,
        { size: 'default', onClick: this.handleOnCancel },
        cancelText || '取消'
      ), _react2.default.createElement(
        _Button2.default,
        { type: 'primary', size: 'default', onClick: this.handleOnTrue },
        okText || '确定'
      )];
