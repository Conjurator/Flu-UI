...
var NavList = function (_PureComponent) {
  ...
  _createClass(NavList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'nav-list' },
        navList.map(function (menu, index) {
          return _react2.default.createElement(_Menu2.default, _extends({ pathname: pathname, key: index }, menu));
        })
      );
    }
  }]);
